...
import 'location_pop_up_model.dart';
export 'location_pop_up_model.dart';

class LocationPopUpWidget extends StatefulWidget {
  const LocationPopUpWidget({super.key});
...
class _LocationPopUpWidgetState extends State<LocationPopUpWidget> {
  late LocationPopUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LocationPopUpModel());
  }
